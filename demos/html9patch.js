...
/**
	...
	if(btn_toggle_off[0] != undefined) {
		var btn_toggle_off_html = "<div id='btn_toggle_off' class='nine-patch'>	<div id='btn_toggle_off_content' style='top:14px; bottom:14px; left:18px; right:18px;'>		Entry Content	</div>	<table cellpadding='0' cellspacing='0'>		<tr>			<td width='9px' height='24px' style='background-image:url(" + imageDirectory + "btn_toggle_off_0.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_1.png);'><img /></td>			<td width='6px' style='background-image:url(" + imageDirectory + "btn_toggle_off_2.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_3.png);'><img /></td>			<td width='6px' style='background-image:url(" + imageDirectory + "btn_toggle_off_4.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_5.png);'><img /></td>			<td width='9px' style='background-image:url(" + imageDirectory + "btn_toggle_off_6.png);'></td>		</tr>		<tr>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_7.png);'><img /></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_8.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_9.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_10.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_11.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_12.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_13.png);'></td>		</tr>		<tr>			<td height='21px' style='background-image:url(" + imageDirectory + "btn_toggle_off_14.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_15.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_16.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_17.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_18.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_19.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_off_20.png);'></td>		</tr>	</table></div>";
		...
		$('#btn_toggle_off_content').html(_html);
	}
	...
	if(btn_toggle_on[0] != undefined) {
		var btn_toggle_on_html = "<div id='btn_toggle_on' class='nine-patch'>	<div id='btn_toggle_on_content' style='top:14px; bottom:14px; left:18px; right:18px;'>		Entry Content	</div>	<table cellpadding='0' cellspacing='0'>		<tr>			<td width='9px' height='24px' style='background-image:url(" + imageDirectory + "btn_toggle_on_0.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_1.png);'><img /></td>			<td width='6px' style='background-image:url(" + imageDirectory + "btn_toggle_on_2.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_3.png);'><img /></td>			<td width='6px' style='background-image:url(" + imageDirectory + "btn_toggle_on_4.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_5.png);'><img /></td>			<td width='9px' style='background-image:url(" + imageDirectory + "btn_toggle_on_6.png);'></td>		</tr>		<tr>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_7.png);'><img /></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_8.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_9.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_10.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_11.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_12.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_13.png);'></td>		</tr>		<tr>			<td height='21px' style='background-image:url(" + imageDirectory + "btn_toggle_on_14.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_15.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_16.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_17.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_18.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_19.png);'></td>			<td style='background-image:url(" + imageDirectory + "btn_toggle_on_20.png);'></td>		</tr>	</table></div>";
	...
	if(html_ul_li_icon[0] != undefined) {
		...
		var _html = html_ul_li_icon.html();
		...
		$('#html_ul_li_icon_content').html(_html);
	}
	...
	if(popup_inline_error_above[0] != undefined) {
		...
		var _html = popup_inline_error_above.html();
		...
		$('#popup_inline_error_above_content').html(_html);
	}
	...
	if(popup_window_bg[0] != undefined) {
		...
		var _html = popup_window_bg.html();
		...
		$('#popup_window_bg_content').html(_html);
	}
	...
	if(scrollbar_handle[0] != undefined) {
		...
		var _html = scrollbar_handle.html();
		...
		$('#scrollbar_handle_content').html(_html);
	}
	...
	if(textfield_selected[0] != undefined) {
		...
		var _html = textfield_selected.html();
		...
		$('#textfield_selected_content').html(_html);
	}
